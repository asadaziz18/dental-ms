...
let SyncController = class SyncController {
    ...
    async push(branchId, user, body) {
        const results = await this.syncService.push(branchId, user.role, user.allowedBranches ?? [], body.operations.map((op) => ({
            entity: op.entity,
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, Object, push_sync_dto_1.PushSyncDto]),
