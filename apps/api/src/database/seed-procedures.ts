...
/** Common CDT-style procedure codes for dental charting */
const PROCEDURES = [
...
export async function seedProcedures(dataSource: DataSource): Promise<void> {
  const repo = dataSource.getRepository(Procedure);
