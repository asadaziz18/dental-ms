...
export type ScreenKey = 'dashboard' | 'patients' | 'appointments' | 'treatments' | 'labs' | 'billing' | 'inventory' | 'staff' | 'imaging' | 'reports' | 'settings';
export declare const SCREEN_KEYS: ScreenKey[];
